...
def _pixel_iterator_from_xarray(ds):
    ...
    lat_size = dimensions['x']
    lat_size = dimensions['y']
    ...
    print ("TONY lat,long size cartesian", lat_size, long_size, cartesian)
...
def _generate_change_matrix(ds, distributed= False):
    ...
    print("TONY - _generate_change_matrix")
    # print(ds)
    return("Bullshit")
